...
class Projector:
    def __init__(self, _num_steps=1000, _dlatent_avg_samples=10000):
        self.num_steps                  = _num_steps
        self.dlatent_avg_samples        = _dlatent_avg_samples
    ...
    def set_network(self, Gs, minibatch_size=1):
        ...
        if self._lpips is None:
            self._lpips = misc.load_pkl('https://drive.google.com/uc?id=1bkLF8YPHBN3prxCr4RxymykqhwSIxKjY') # vgg16_zhang_perceptual.pkl
